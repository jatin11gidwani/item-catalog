...
8. *Insert fake data `python /item-catalog/lotsofcategories.py`
...
Category Items JSON: `/category/<int:category_id>/catalog/JSON`
    - Displays items for a specific category

Category Item JSON: `/category/<int:category_id>/catalog/<int:catalog_id>/JSON`
